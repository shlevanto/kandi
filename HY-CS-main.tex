...
\documentclass[finnish,twoside,tkt,censored]{HYthesisML} 
...
\usepackage{tikzit} % tikz made easier
\input{tyyli.tikzstyles}
...
\title{Bayes-verkot työkyvyttömyysriskin mallintamisessa}
...
\supervisors{apulaisprofessori Arto Klami}

\keywords{Bayesian networks, structure learning, machine learning, graphical models}
...
Computing methodologies $\rightarrow$ \
Machine learning $\rightarrow$  \
Machine learning approaches $\rightarrow$  \\
Learning in probabilistic graphical models $\rightarrow$  \
...
\hypersetup{
    ...
    pdftitle={Bayes-verkot työkyvyttömyysriskin mallintamisessa},            % title
    pdfauthor={Simo Levanto},           % author
    pdfsubject={},          % subject of the document
    pdfcreator={Simo Levanto},          % creator of the document
...
\include{Ch.11_Tausta_ja_terminologia}
\include{Ch.20_Bayes-verkot}
\include{Ch.30_Sovelluskohteet}
%\include{Ch.40_Ohjelmistot}
\include{Ch.50_Johtopaatokset}
