...
Tämän jälkeen tarkastellaan Bayes-verkkojen sovelluskohteita ja erityistapauksena niiden soveltamismahdollisuuksia työeläkedatassa yksilötason työkyvyttömyysriskin mallintamisessa ja ennustamisessa. Työkyvyttömyysriskin mallintamisella ja ennustamisella on pitkät tilastotieteelliset perinteet, mutta koneoppimismallien soveltaminen niihin on vasta alussa ja julkaistua tutkimusta aiheesta on vähän. Yhteistä julkaistuille ja alustaville koneoppimismallien sovelluksille on, ettei niissä ole tarkasteltu muuttujien välisiä riippuvuussuhteita kuin korkeintaan pareittain. Bayes-verkon rakenteen oppiminen tarjoaa mahdollisuuden kuvata näitä riippuvuussuhteita.

Tutkielmassa käydään läpi keskeisiä algoritmeja Bayes-verkkojen rakentamiseen ja esitellään avoimesti saatavilla olevia ohjelmistokirjastoja algoritmien toteuttamiseen.
